...
@Slf4j
public class AchieveSendFailMsg extends AchieveREInitiator {
    ...
    public AchieveSendFailMsg(Agent a, ACLMessage msg) {
        super(a, msg);
    }

    @Override
    public void onStart() {
        this.receiverAgent = findNexInQueue(myAgent.getAID());
        super.onStart();
    }
